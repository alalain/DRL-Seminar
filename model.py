...
class Actor(tf.keras.Model):
    ...
    def __init__(self,
        ...
        uniform_init = tf.keras.initializers.RandomUniform(-0.007, 0.007, seed=42)
...
class CriticQ(tf.keras.Model):
    ...
    def __init__(self, num_input: int, units_per_layer: int = 256):
        ...
        uniform_init = tf.keras.initializers.RandomUniform(-0.007, 0.007, seed=41)
...
class CriticV(tf.keras.Model):
    ...
    def __init__(self, num_input: int, units_per_layer: int = 256):
        ...
        uniform_init = tf.keras.initializers.RandomUniform(-0.007, 0.007, seed=40)
        self.critic = layers.Dense(1,
                                   kernel_initializer=uniform_init,
                                   bias_initializer=uniform_init)
